    ...
    <ul class="nav-list">
                ...
                <div class="column">
                    ...
                    <div class="column-content">
                        <div class="column-summary">
                            ...
                            <div class="big-number enrollment-current">405</div>
                        </div>
                        <div class="column-summary-card">
                            <h4>SUMMARY PREV S.Y.</h4>
                            <h5>NEW ENROLLEES SEPTEMBER S.Y. 2024-2025</h5>
                            <div class="big-number enrollment-previous">380</div>
                            </div>
                        </div>
                ...
                <div class="column">
                    ...
                    <div class="column-content">
                        <div class="column-summary">
                            ...
                            <div class="big-number collection-current">₱45,000,000</div>
                        </div>
                        <div class="column-summary-card">
                            <h4>COLLECTION PREV S.Y.</h4>
                            <h5>TOTAL COLLECTION S.Y. 2024-2025</h5>
                            <div class="big-number collection-previous">₱42,500,000</div>
                            </div>
                        </div>
                        <div class="column-chart">
                ...
                <div class="column">
                    ...
                    <div class="column-content">
                        <div class="column-summary">
                            ...
                            <div class="big-number payables-current">₱8,500,000</div>
                        </div>
                        <div class="column-summary-card">
                            <h4>PAYABLES PREV S.Y.</h4>
                            <h5>TOTAL OUTSTANDING PAYABLES S.Y. 2024-2025</h5>
                            <div class="big-number payables-previous">₱7,200,000</div>
                            </div>
                        </div>
                        <div class="column-chart">
        ...
        <script>
            // Data from PHP
            const campusData = {"name":"BI\u00d1AN","enrollment":{"current_year":405,"previous_year":380,"per_sy":[350,380,420,380,405],"per_college":{"CAS":45,"CBA":38,"CCS":42,"CEA":35,"CHM":28,"CME":25,"COED":32,"CRM":18,"GRAD":15,"LAW":22,"SOA":20}},"collection":{"current_year":45000000,"previous_year":42500000,"monthly":[3200000,3800000,4200000,3900000,4100000,3800000,3600000,4000000,4500000,4200000,3800000,3500000]},"accounts_payable":{"current_year":8500000,"previous_year":7200000,"by_category":{"Supplies":2500000,"Utilities":1800000,"Maintenance":1500000,"Equipment":1200000,"Services":1000000,"Other":500000}}};
            const isAllCampuses = false;
            const currentCampus = 'binan';
            ...
            const enrollmentChart = new Chart(enrollmentCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Enrollees',
                        data: [45,38,42,35,28,25,32,18,15,22,20],
            ...
            const collectionChart = new Chart(collectionCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Collection (₱)',
                        data: [3200000,3800000,4200000,3900000,4100000,3800000,3600000,4000000,4500000,4200000,3800000,3500000],
            ...
            const accountsPayableChart = new Chart(accountsPayableCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [2500000,1800000,1500000,1200000,1000000,500000],
