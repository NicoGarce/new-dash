    ...
    <head>
        ...
        <title>MEDICAL UNIVERSITY Dashboard</title>
    ...
    <ul class="nav-list">
                ...
                <div class="column">
                    ...
                    <div class="column-content">
                        <div class="column-summary">
                            ...
                            <div class="big-number enrollment-current">120</div>
                        </div>
                        <div class="column-summary-card">
                            <h4>SUMMARY PREV S.Y.</h4>
                            <h5>NEW ENROLLEES SEPTEMBER S.Y. 2024-2025</h5>
                            <div class="big-number enrollment-previous">110</div>
                            </div>
                        </div>
                ...
                <div class="column">
                    ...
                    <div class="column-content">
                        <div class="column-summary">
                            ...
                            <div class="big-number collection-current">₱12,000,000</div>
                        </div>
                        <div class="column-summary-card">
                            <h4>COLLECTION PREV S.Y.</h4>
                            <h5>TOTAL COLLECTION S.Y. 2024-2025</h5>
                            <div class="big-number collection-previous">₱11,000,000</div>
                            </div>
                        </div>
                        <div class="column-chart">
                ...
                <div class="column">
                    ...
                    <div class="column-content">
                        <div class="column-summary">
                            ...
                            <div class="big-number payables-current">₱2,200,000</div>
                        </div>
                        <div class="column-summary-card">
                            <h4>PAYABLES PREV S.Y.</h4>
                            <h5>TOTAL OUTSTANDING PAYABLES S.Y. 2024-2025</h5>
                            <div class="big-number payables-previous">₱2,000,000</div>
                            </div>
                        </div>
                        <div class="column-chart">
        ...
        <script>
            // Data from PHP
            const campusData = {"name":"MEDICAL UNIVERSITY","enrollment":{"current_year":120,"previous_year":110,"per_sy":[100,105,110,110,120],"per_college":{"CAS":12,"CBA":10,"CCS":11,"CEA":9,"CHM":8,"CME":7,"COED":9,"CRM":5,"GRAD":3,"LAW":6,"SOA":5}},"collection":{"current_year":12000000,"previous_year":11000000,"monthly":[900000,1000000,1100000,1000000,1150000,1050000,950000,1100000,1200000,1100000,950000,900000]},"accounts_payable":{"current_year":2200000,"previous_year":2000000,"by_category":{"Supplies":650000,"Utilities":480000,"Maintenance":400000,"Equipment":300000,"Services":250000,"Other":120000}}};
            const isAllCampuses = false;
            const currentCampus = 'med-university';
            ...
            const collectionChart = new Chart(collectionCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Collection (₱)',
                        data: [900000,1000000,1100000,1000000,1150000,1050000,950000,1100000,1200000,1100000,950000,900000],
            ...
            const accountsPayableChart = new Chart(accountsPayableCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [650000,480000,400000,300000,250000,120000],
